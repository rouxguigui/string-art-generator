    ...
    <div class="content" v-if="tabSelected === 'string'">
      ...
      <b-form-group class="property">
        ...
        <b-input-group class="mt-1">
          <b-btn variant="default" class="mr-1" @click="$refs.colorPalette.show()"><i class="fas fa-palette"></i>
          </b-btn>
          <b-input type="number" min="0" max="360" @change="updateLayerColorHSL"
                   v-model.number="layerColorHSL[0]"></b-input>
          <b-input-group-text class="px-1">°</b-input-group-text>
          <b-input type="number" min="0" max="100" @change="updateLayerColorHSL"
                   v-model.number="layerColorHSL[1]"></b-input>
          <b-input-group-text class="px-1">%</b-input-group-text>
          <b-input type="number" min="0" max="100" @change="updateLayerColorHSL"
                   v-model.number="layerColorHSL[2]"></b-input>
